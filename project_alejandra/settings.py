"""
Django settings for project_alejandra project.
...
ALLOWED_HOSTS = ['159.65.254.163', '127.0.0.1']
...
ROOT_URLCONF = 'project_alejandra.urls'
...
WSGI_APPLICATION = 'project_alejandra.wsgi.application'
